...
public abstract class ObstaclePreview {
	...
	public ObstaclePreview(Image img, int largeur) {
		this(img,largeur,largeur);
	}

	public ObstaclePreview(Image img, int largeur, int hauteur) {
		this.img = img;
		this.hauteur = hauteur;
		this.largeur = largeur;
		y1 = y2 = 0;
		x1 = x2 = x = Etat.LARGEUR / 2;
	}
	...
	public void move(Etat etat) {
		...
		y2 = etat.transformePositionToPerspective(x + hauteur,y1) - x + y1;
